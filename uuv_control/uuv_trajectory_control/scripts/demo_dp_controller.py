...
if __name__ == '__main__':
    ...
    wp1 = uuv_waypoints.Waypoint(0, 0, -2, 0.3, inertial_frame_id='world')
    wp2 = uuv_waypoints.Waypoint(3, 2, -1, 0.3, inertial_frame_id='world')
    wp3 = uuv_waypoints.Waypoint(3, 0, -2, 0.5, inertial_frame_id='world')
    wp4 = uuv_waypoints.Waypoint(3, 3, -2, 0.5, inertial_frame_id='world')
